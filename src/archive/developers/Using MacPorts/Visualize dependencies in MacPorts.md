...
![](/archive/img/developers/macports/macports-dependencies-overview/graphviz.png)
...
![](/archive/img/developers/macports/macports-dependencies-overview/portviz%20legend.png)
...
![](/archive/img/developers/macports/macports-dependencies-overview/rrdtool_directed.png)


The circular view:

![](/archive/img/developers/macports/macports-dependencies-overview/rrdtool_circular.png)


The radial view:


![](/archive/img/developers/macports/macports-dependencies-overview/rrdtool_radial.png)


The first undirected view:

![](/archive/img/developers/macports/macports-dependencies-overview/rrdtool_undirected.png)

The second undirected view:

![](/archive/img/developers/macports/macports-dependencies-overview/rrdtool_undirectedBIS.png)
...
![](/archive/img/developers/macports/macports-dependencies-overview/pd_portviz%20graphviz%20radial.png)
...
![](/archive/img/developers/macports/macports-dependencies-overview/graphviz_undirectedBIS.png)


Why is it hard to compile a "pure" *kde3*?


![](/archive/img/developers/macports/macports-dependencies-overview/pd_portviz%20kde_directed.png)

Why is it also hard to compile a "pure" *gnome?*

![](/archive/img/developers/macports/macports-dependencies-overview/pd_portviz%20gnome_directed.png)
Ressources
----------
