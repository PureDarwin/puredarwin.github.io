...
![](/archive/img/developers/repository/pd_roots_overview.gif)
...
![](/archive/img/developers/repository/releases_chicken_egg.gif)
...
PureDarwin bootstrap will contains the same packages (c.f. pd_roots.bootstrap)  which have been used to make it. Because "`pd_roots.nano` âˆˆ `pd_roots.bootstrap` âˆˆ `pd_roots", PureDarwin bootstrap will be only able to generate itself or a PureDarwin nano.


![](/archive/img/developers/repository/pd_roots_overview_without_shortcircuiting_arcs.gif)
