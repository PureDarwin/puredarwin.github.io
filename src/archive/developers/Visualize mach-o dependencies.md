...
![](/archive/img/developers/otool/mach-o-dependencies-overview/otool.dot_directed.png)
...
![](/archive/img/developers/otool/mach-o-dependencies-overview/xterm.dot_circular.png)
#### Checking for purity in passwd

![](/archive/img/developers/otool/mach-o-dependencies-overview/passwd.dot_undirectedBIS.png)
