...
**please see: **[http://www.puredarwin.org/developers/virtualbox](VirtualBox.md)
**
**
**
**
...
![](/archive/img/developers/virtualbox/video.png)


__Note:__ Passing kernel flag "Graphics Mode"="&lt;value&gt;" also seems to work.
#### ?memory flag

![](/archive/img/developers/virtualbox/memory.png)
...
![](/archive/img/developers/virtualbox/Virtualbox%20voodoo%20chameleon%20bootloader.png)


With ACPI enabled in VirtualBox, the vm hangs at "Local APIC version not 0x14 as expected":

![](/archive/img/developers/virtualbox/Virtualbox%20voodoo%20chameleon%20ACPI.png)

Without ACPI, it complains about and irremediably lead to a kernel panic.
****
![](/archive/img/developers/virtualbox/Virtualbox%20voodoo%20chameleon%20NOACPI.png)
...
![](/archive/img/developers/virtualbox/ExperimentalPAE.png)
