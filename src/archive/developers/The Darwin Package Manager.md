...
This is Stuart and Aladin's proposal for "dm", a Darwin Package Manager. It is based on the discussion on the [Package management](Package%20management.md) page.
...
![](/archive/img/developers/package-management/the-darwin-package-manager/dbaudit.png)
...
![](/archive/img/developers/package-management/the-darwin-package-manager/pdpdmake.png)
