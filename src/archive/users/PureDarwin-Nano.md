...
![](/archive/img/downloads/puredarwin-nano/Bild%202.png)
...
![](/archive/img/downloads/puredarwin-nano/bash%20interactive%20mode%20in%20nano.png)

The Z shell (zsh) is also usable as an interactive UNIX command interpreter (shell).

![](/archive/img/downloads/puredarwin-nano/VMware%20running%20PureDarwin%20nano%20with%20interactive%20commands.png)
...
![](/archive/img/downloads/puredarwin-nano/nanovmwarelittlegray.png)

### <a name="VM-QEMU"></a>QEMU

![](/archive/img/downloads/puredarwin-nano/qemu1.png)
